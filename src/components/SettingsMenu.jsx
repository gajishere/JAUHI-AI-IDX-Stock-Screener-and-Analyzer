  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className={`inline-flex min-h-11 min-w-11 items-center justify-center rounded-full border border-line bg-paper text-ink-muted shadow-sm shadow-ink/5 transition-[transform,color,background-color] duration-200 hover:scale-[1.04] hover:text-ink active:scale-[0.95] sm:min-h-9 sm:min-w-9 ${
          open ? 'text-ink' : ''
        }`}
      >
        <GearIcon />
        ...
        >
          <div>
            ...
            <div
              ...
              className="inline-flex w-full items-center gap-1 rounded-full border border-line bg-well/60 p-1"
            >
              {THEMES.map(({ value, labelEn, labelId, Icon }) => {
                ...
                return (
                  <button
                    ...
                    aria-pressed={active}
                    className={`inline-flex min-h-11 flex-1 items-center justify-center gap-1.5 rounded-full px-3 text-xs font-medium transition-[transform,color,background-color] duration-200 hover:scale-[1.02] active:scale-[0.95] sm:min-h-9 ${
